...
## Course sessions
Class meetings will typically consist of a 1-hour seminar, covering a combination of background material and case studies on genetics and genomics concepts as well as state of the art research advances. Some class meetings will be devoted to discussions of recent journal articles.

## Prerequisites
There are no official prerequisites for the course. It is assumed attendees have some basic background in genetics. The target audience is clinical and graduate level trainees with an interest in medical genetics and genomics. Trainees from a range of backgrounds are encouraged to attend.

## Course objectives
* Describe the molecular basis of genetic disease, including single-gene disorders, chromosomal abnormalities, repeat expansion disorders, mitochondrial diseases, and complex traits
* Gain the ability to select and interpret the appropriate genetic tests based on the clinical presentation of a patient.
Understand and evaluate emerging technologies for precision genomics
